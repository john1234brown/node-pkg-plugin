...
//Support For Rollup as well! Enjoy! :D
import fs from 'fs';
import path from 'path';
import crypto from 'crypto';
import { spawn } from 'child_process';

export default function nodePkgPlugin(fileName = 'app.js', outputFileName = 'app', typescript = false) {
  ...
  return {
    ...
    async buildStart() {
      const tamperFilePath = path.resolve(__dirname, tamperFile);
...
module.exports = NodePkgPlugin; nodePkgPlugin;